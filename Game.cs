...
namespace NoClippy
{
    public static unsafe class Game
    {
        ...
        public static readonly Memory.Replacer fixGCDRecast = new("F6 47 3B 02 74 3E 8D 83 83 C1 FF FF", new byte[] { 0xF6, 0x47, 0x3B, 0x02, 0x75 }, NoClippy.Config.TEMPMudraFix);
